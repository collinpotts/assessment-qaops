...
const drawFive = () => {
    axios.get('http://34.207.161.102/api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://34.207.161.102/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://34.207.161.102/api/player')
...
const getAllBots = () => {
    axios.get('http://34.207.161.102/api/robots')
        .then(({data}) => {
